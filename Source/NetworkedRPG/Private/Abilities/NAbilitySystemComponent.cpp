...
#include "AutomationWorker/Private/AutomationAnalyticParams.h"
...
void UNAbilitySystemComponent::AbilityLocalInputPressed(int32 InputID)
{
...
void UNAbilitySystemComponent::OnGiveAbility(FGameplayAbilitySpec& AbilitySpec)
{
    Super::OnGiveAbility(AbilitySpec);
   
    // UKismetSystemLibrary::PrintString(GetWorld(), AbilitySpec.GetDebugString() + " " + FString::FromInt(AbilitySpec.InputID));
}

void UNAbilitySystemComponent::BindAbilityActivationToInputComponent(UInputComponent* InputComponent, FGameplayAbilityInputBinds BindInfo)
{
...
void UNAbilitySystemComponent::ExecuteGameplayCueLocal(const FGameplayTag GameplayCueTag, const FGameplayCueParameters GameplayCueParameters)
{
    UAbilitySystemGlobals::Get().GetGameplayCueManager()->HandleGameplayCue(GetOwner(), GameplayCueTag, EGameplayCueEvent::Type::Executed, GameplayCueParameters);
}

void UNAbilitySystemComponent::AddGameplayCueLocal(const FGameplayTag GameplayCueTag, const FGameplayCueParameters GameplayCueParameters)
{
    UAbilitySystemGlobals::Get().GetGameplayCueManager()->HandleGameplayCue(GetOwner(), GameplayCueTag, EGameplayCueEvent::Type::OnActive, GameplayCueParameters);
}

void UNAbilitySystemComponent::RemoveGameplayCueLocal(const FGameplayTag GameplayCueTag, const FGameplayCueParameters GameplayCueParameters)
{
...
float UNAbilitySystemComponent::GetMaxAttributeUpdatesPerSecond()
{
    return 0.f;
}
