...
ANGATA_LineTrace::ANGATA_LineTrace()
{
}

void ANGATA_LineTrace::Configure(
...
void ANGATA_LineTrace::DoTrace(TArray<FHitResult>& HitResults, const UWorld* World,
...
void ANGATA_LineTrace::ShowDebugTrace(TArray<FHitResult>& HitResults, EDrawDebugTrace::Type DrawDebugType,
    float Duration)
{
...
void ANGATA_LineTrace::DrawDebugLineTraceMulti(const UWorld* World, const FVector& Start, const FVector& End, EDrawDebugTrace::Type DrawDebugType, bool bHit, const TArray<FHitResult>& OutHits, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime)
{
