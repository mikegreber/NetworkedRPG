...
#include "Characters/Components/NInteractionComponent.h"
...
void ANCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	// Mechanics
	PlayerInputComponent->BindAction("ToggleCombatMode", IE_Pressed, this, &ANCharacter::ToggleCombatMode);
...
void ANCharacter::ToggleCombatMode()
{
	if (MovementSystemComponent->GetCombatMode() == ENCombatMode::None)
	{
		MovementSystemComponent->SetCombatMode(ENCombatMode::Melee);
	}
	else
	{
		MovementSystemComponent->SetCombatMode(ENCombatMode::None);
	}
}
