...
#include "Components/Targeting/NTargetingComponentInterface.h"
...
void UNTargetingComponent::OnMovementSystemUpdated(ENMovementGait InMovementMode, ENRotationMode InRotationMode, ENStance InStance)
{
	if (IsLocked() && InStance != ENStance::None || InStance != ENStance::Ranged)
	{
