...
class NETWORKEDRPG_API UNTargetingComponent : public UActorComponent
{
	...
	/** Sphere in which a target must be to be detected. */
...
public:
	...
	/**
	 *Actions to bind from actor that owns this component - could perhaps also bind from within this component
	**/
...
private:
	...
	UFUNCTION()
    void OnMovementSystemUpdated(ENMovementGait InMovementMode, ENRotationMode InRotationMode, ENCombatMode InCombatMode);
