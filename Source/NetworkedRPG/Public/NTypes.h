...
struct FCameraMode
{
	...
	FCameraMode(const FVector& SocketOffset, const float CameraLagSpeed, const float CameraRotationLagSpeed,
		const float CameraLagMaxDistance)
...
struct FCameraModeSettings
{
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "MovementSystem|Camera")
    FCameraMode Walking;
